        ...
        body: ListView.separated(
          itemBuilder: (BuildContext context, int Noticia){
            return Card(
              color: Colors.white,
              child: ListTile(
                leading: Text(tabela[Noticia].titulo_noticia, style: TextStyle(color: Colors.red, fontWeight: FontWeight.bold, fontSize: 18)),
                title: Text(tabela[Noticia].texto_noticia, style: TextStyle(color: Colors.black)),
                trailing: Text(tabela[Noticia].data_noticia, style: TextStyle(color: Colors.black)),
              )
            );
          },
