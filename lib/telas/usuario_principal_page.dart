          ...
          children: [
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ClipRRect(
                    child: Image.asset(widget.aluno.icone.toString(), width: 150,),
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(widget.aluno.email_aluno.toString(), style: TextStyle(fontSize: 15))
                    ],
                  ),
                ),
                Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(widget.aluno.rg_aluno.toString(), style: TextStyle(fontSize: 15))
                    ],
                  ),
                )
              ],
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(widget.aluno.instituicao.toString(), style: TextStyle(fontSize: 15))
                    ],
                  ),
                )
              ],
              ...
              children: [
                Padding(
                  ...
                  child: Column(
                    children:[
                      Icon(Icons.phone),
                      Text('Telefone para Contato:', style: TextStyle(fontSize: 23)),
                      Text(widget.aluno.telefone_aluno.toString(), style: TextStyle(fontSize: 15))
                    ],
